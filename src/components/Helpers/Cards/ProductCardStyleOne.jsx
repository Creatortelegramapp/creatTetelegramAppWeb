...
export default function ProductCardStyleOne({datas, type}) {
    ...
    return (
        ...
        >
            ...
            {/*        //             </Link>*/}
            {/*        //             <p className="price">*/}
            {/*        //                 <div className="main-price  font-600 text-[18px]">*/}
            {/*        //                     <p>{data.price}$</p>*/}
            {/*        //*/}
            {/*        //                 </div>*/}
            {/*        //             </p>*/}
            ...
            {/*)}*/}
            {/*{datas.length > 0 &&*/}
            {/*    datas.slice(1, 2).map((data, index) => (*/}
            {/*        <div  className="product-card-img w-full h-[300px] flex">*/}
            {/*            /!*<img src={datas.media_urls[0]} alt=""/>*!/*/}
            {/*            <div className="product-card-details px-[30px] pb-[30px] relative flex">*/}
            {/*                <p className="title mb-2 text-[15px] font-600">{datas.name}</p>*/}
